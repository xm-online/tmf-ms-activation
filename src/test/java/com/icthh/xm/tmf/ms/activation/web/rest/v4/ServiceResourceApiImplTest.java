...
import com.icthh.xm.tmf.ms.activation.service.ServiceResourceHelperServiceImpl;
...
@ContextConfiguration(classes = {ServiceResourceApiController.class, ServiceResourceApiImpl.class,
    ExceptionTranslator.class, ServiceResourceHelperServiceImpl.class, ServiceMapperImpl.class})
